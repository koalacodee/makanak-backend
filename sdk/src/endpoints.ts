...
export class CategoriesEndpoints {
  ...
  async list(includeHidden?: boolean): Promise<Category[]> {
    ...
    return this.client.get('v1/categories', { searchParams }).json<Category[]>()
  }
...
export class OrdersEndpoints {
  ...
  async list(query?: OrderQuery): Promise<OrdersResponse> {
    ...
    return this.client.get('v1/orders', { searchParams }).json<OrdersResponse>()
  }
...
export class CartEndpoints {
  ...
  async updateItem(
    ...
    return this.client.patch(`v1/carts/items/${itemId}`, { json: input }).json()
  }
  ...
  async buyNow(phone: string, input: BuyNowInput): Promise<Order> {
    return this.client.post(`v1/carts/${phone}/buy-now`, { json: input }).json()
  }
}
